...
observations: {
  ...
  blossomEndRot:
    "Rot at the bottom of the fruit",
  ...
  crop: {
    ...
    description:
      "Select the crop affected by the problem you are observing.",
    maize: "Maize",
    ...
    whyDescription:"Questions and recommendations will be adapted to your selection.",
  ...
  plantPart: {
    ...
    unknown: "I don't know",
    unsure: "Not sure?",
    unsureDescription:"Select “I don't know”. AgriMboa will ask other questions.",
    commonDescription:"Select where you observe the problem. You may select several answers.",

    maize: {
      title:
        "Which part of the maize plant is affected?",
    },

    cassava: {
      title:
        "Which part of the cassava plant is affected?",
    },

    tomato: {
      title:
        "Which part of the tomato plant is affected?",
    },

    plantain: {
      title:
        "Which part of the plantain is affected?",
    },
  },
  ...
  symptoms: {
    ...
    absentDescription:"You can describe it in your own words in the next step.",
    commonDescription:"Select all the symptoms you observe.",

    maize: {
      title:
        "What do you see on the maize plant?",
    },

    cassava: {
      title:
        "What do you see on the cassava plant?",
    },

    tomato: {
      title:
        "What do you see on the tomato plant?",
    },

    plantain: {
      title:
        "What do you see on the plantain?",
    },
  },
  ...
  description: {
    ...
    offlineVoice:
      "Transcription and analysis remain available offline.",
